    ...
    <div class="container position-relative mt-sm-5">
        ...
        <div class="row g-4 justify-content-between">
                ...
                <div class="row g-4">
                    ...
                    <div class="col-md-6">
                        ...
                        <ul class="list-group list-group-borderless">
                            <li class="d-flex mb-3"><i class="me-2 text-primary bi bi-geo-alt"></i>1421 Coburn Hollow
                                Road Metamora, Near Center Point, IL 61548. </li>
                            <li class="d-flex mb-3"><i class="me-2 text-primary bi bi-headset"></i> (251) 854-6308 </li>
                            <li class="d-flex mb-3"><i class="me-2 text-primary bi bi-envelope"></i> help@example.com
                            </li>
                            <li class="d-flex mb-3"><i class="me-2 text-primary bi bi-clock"></i>
                                <p class="mb-0">Mon - Fri: <strong>09:00 - 21:00</strong> <br>Sat - Sun:
            ...
            <div class="col-lg-3">
                ...
                <ul class="list-inline mb-0 mt-3">
                    ...
                    <li class="list-inline-item"> <a class="btn btn-xs btn-icon bg-twitter" href="#"><i
                    ...
                    <li class="list-inline-item"> <a class="btn btn-xs btn-icon bg-youtube" href="#"><i
        ...
        <div class="d-md-flex justify-content-between align-items-center text-center text-lg-start py-3">
            ...
            <a class="navbar-brand" href="index-2.html">
                <img class="light-mode-item navbar-brand-item h-40px" src="{{ asset('logo.png')}}" alt="logo">

            </a>

            <!-- Copyright link-->
            <div class="text-body mt-3 mt-md-0"> Copyrights ©2024 Artixcore</a>.</div>
            <!-- Copyright link-->
        </div>
    </div>
</footer>
