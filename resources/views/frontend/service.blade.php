...
@section('content')
    ...
    <main>
            ...
            <div class="container position-relative pt-4 pt-lg-0">
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-5 mb-5 mb-md-0">
                        <h1 class="mb-4">Unleash the Power of Applications</h1>
                        <p class="mb-4">This structure maintains a focus on the strength and potential of your SAAS
                            features while providing an invitation to explore them further.</p>
                    ...
                    <div class="col-lg-6 ms-auto">
                        <div class="position-relative pe-4 pe-sm-6">
                            <!-- Bg dark pattern -->
                            <div class="bg-dark rounded position-absolute top-0 end-0 w-50 h-100"
                                style="background-image:url(assets/images/elements/bg-pattern-2.png); background-position: center left; background-size: cover;">
                            </div>

                            <img src="assets/images/bg/saas-bg.jpg"
                                class="rounded-4 border border-dark border-5 my-4 my-sm-6 position-relative" alt="saas-img">
                            <div class="col-2 position-absolute bottom-0 start-0 ms-lg-n7">
                                <img src="assets/images/elements/saas-decoration/01.png" class="shadow rounded-4"
                                    alt="decoration-img">
                            </div>
                        </div>
                    </div>
        ...
        <section class="pt-0">
            <div class="container">
                ...
                <div class="inner-container-small text-center mb-4 mb-sm-5">
                    ...
                    <p class="mb-0">There is nothing that can stop you from achieving what you want, except yourself. If
                        you devote yourself to it you will achieve your goal.</p>
                </div>
                    ...
                    <div class="col-xl-4">
                        <div class="card card-body d-flex p-4 border h-100 flex-md-row flex-xl-column">
                            ...
                            <div class="me-md-5 me-xl-0 mb-4 mb-md-0">
                                ...
                                <p class="mb-3">Our platform offers a comprehensive suite of features designed to empower
                                    your business.</p>
                                    ...
                                    <div class="row g-4">
                                        <div class="col-md-6">
                                            <div class="card-body p-0">
                                                ...
                                                <!-- Title and content -->
                                                <h5 class="card-title mb-3">Collaborating on work shouldn't be this hard
                                                </h5>
                                                <p class="mb-3">We provide digital transformation solutions, enabling
                                                    companies to make their visions. </p>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="me-n9 mb-n6">
                                                <img src="assets/images/elements/saas-feature.png"
                                                    class="card-img border border-dark border-5" alt="feature-img">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-lg-6">
                                <div class="card bg-dark rounded h-100 overflow-hidden p-5">
                                    ...
                                    <figure class="position-absolute bottom-0 end-0 mb-n4 me-n5">
                                        <svg class="fill-white opacity-1" width="220px" height="209px"
                                            viewBox="0 0 220 209" style="enable-background:new 0 0 220 209;"
                                            xml:space="preserve">
                                            <path
                            ...
                            <div class="col-lg-6">
                                <div class="card bg-light rounded h-100 overflow-hidden p-4">
                                    ...
                                    <div class="card-body bg-transparent p-0">
                                        ...
                                        <p class="mb-0">Ample order up in of in ready. Timed blind had now those ought
                                            set often which. Or snug dull he show more true wish.</p>
                                    </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-xl-10 text-center mx-auto">
                        ...
                        <h1 class="mb-4">We are an Independent Brand, Design, and Communication Agency</h1>
                        <p class="lead mb-0">We are an insight and behaviors driven creative marketing agency. A Full
                            package
                            Digital Creative Agency Specializing in: Video Production, Web Design, Branding, Brand Strategy,
                            Content Marketing and Aerial Cinematography.</p>
            ...
            <div class="container">
                <div class="row g-4 align-items-center">
                        ...
                        <div class="row g-xl-5">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="card card-body bg-light p-4 mt-5">
                                    ...
                                    <p class="mb-0"> We believe that the best results are born from the synergy of
                                        diverse</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-6 ps-xl-7">
                        ...
                        <p>At Mizzle, we're not just in the business of digital solutions; we're in the business of crafting
                            digital success stories. Founded on a passion for innovation and a commitment to excellence,
                            we've been at the forefront of the digital landscape, helping businesses like yours thrive in
                            the digital age.</p>
                        <p>Our story begins with a vision – a vision to transform the digital experience for businesses of
                            all sizes. Over the years, we've evolved from a small startup to a dynamic digital agency with a
                            global footprint.</p>
                        <p class="mb-4">To empower businesses to achieve their digital goals. We believe that the digital
                            realm offers boundless opportunities for growth and connection, and we're here to guide you
                            through this transformative journey.</p>
                        <!-- Button -->
                        <a class="btn btn-dark me-3 mb-0" href="services.html">Explore services!</a>
                        <a class="icon-link icon-link-hover" href="contact-v2.html">Request a quote<i
        ...
        <section class="pt-0">
            <div class="container">
                ...
                <div class="d-lg-flex justify-content-between align-items-center mb-4 mb-lg-5">
                    <!-- Title -->
                    <h4 class="mb-3 mb-lg-0">Explore integration</h4>
                    <!-- Tabs -->
                        ...
                        <div class="card card-hover-shadow border-primary-hover border h-100 p-4">
                            <div class="card-body p-0">
                                ...
                                <div class="d-flex gap-3 align-items-center mb-3">
                                    <img src="assets/images/elements/github.svg" class="h-40px" alt="Integrations-icon">
                                    <h6 class="mb-0">Github</h6>
                                </div>
                                <p>GitHub employs Git, a distributed version control system, to track changes to code over
                                    time. </p>
                            </div>
                    ...
                    <div class="col-sm-6 col-lg-4 col-xl-3">
                        <div class="card card-hover-shadow border-primary-hover border h-100 p-4">
                            <div class="card-body p-0">
                                <!-- Logo -->
                                <div class="d-flex gap-3 align-items-center mb-3">
                                    <img src="assets/images/elements/dropbox.svg" class="h-40px" alt="Integrations-icon">
                                    <h6 class="mb-0">Dropbox</h6>
                                </div>
                                <p>Integrating Dropbox with backup solutions can provide an additional layer of data
                                    protection.</p>
                            </div>
                    ...
                    <div class="col-sm-6 col-lg-4 col-xl-3">
                        <div class="card card-hover-shadow border-primary-hover border h-100 p-4">
                            <div class="card-body p-0">
                                <!-- Logo -->
                                <div class="d-flex gap-3 align-items-center mb-3">
                                    <img src="assets/images/elements/reddit.svg" class="h-40px" alt="Integrations-icon">
                                    <h6 class="mb-0">Reddit</h6>
                                </div>
                                <p>With Reddit integration, you can easily share Reddit posts or comments on other like
                                    blogs or websites.</p>
                            </div>
                    ...
                    <div class="col-sm-6 col-lg-4 col-xl-3">
                        <div class="card card-hover-shadow border-primary-hover border h-100 p-4">
                            <div class="card-body p-0">
                                <!-- Logo -->
                                <div class="d-flex gap-3 align-items-center mb-3">
                                    <img src="assets/images/elements/mailchimp.svg" class="h-40px"
                                        alt="Integrations-icon">
                                    <h6 class="mb-0">Mailchimp</h6>
                                </div>
                                <p>Integrating with data analysis tools allows for deeper segmentation and personalized
                                    messaging. </p>
                            </div>
                    ...
                    <div class="col-sm-6 col-lg-4 col-xl-3">
                        <div class="card card-hover-shadow border-primary-hover border h-100 p-4">
                            <div class="card-body p-0">
                                <!-- Logo -->
                                <div class="d-flex gap-3 align-items-center mb-3">
                                    <img src="assets/images/elements/shopify.svg" class="h-40px" alt="Integrations-icon">
                                    <h6 class="mb-0">Shopify</h6>
                                </div>
                                <p>Shopify employs Git, a distributed version control system, to track changes to code over
                                    time. </p>
                            </div>
                    ...
                    <div class="col-sm-6 col-lg-4 col-xl-3">
                        <div class="card card-hover-shadow border-primary-hover border h-100 p-4">
                            <div class="card-body p-0">
                                <!-- Logo -->
                                <div class="d-flex gap-3 align-items-center mb-3">
                                    <img src="assets/images/elements/slack.svg" class="h-40px" alt="Integrations-icon">
                                    <h6 class="mb-0">Slack</h6>
                                </div>
                                <p>Integrating Slack with project management tools like Trello, Asana, or Jira enables teams
                                    to receive.</p>
                            </div>
                    ...
                    <div class="col-sm-6 col-lg-4 col-xl-3">
                        <div class="card card-hover-shadow border-primary-hover border h-100 p-4">
                            <div class="card-body p-0">
                                <!-- Logo -->
                                <div class="d-flex gap-3 align-items-center mb-3">
                                    <img src="assets/images/elements/google-drive.svg" class="h-40px"
                                        alt="Integrations-icon">
                    ...
                    <div class="col-sm-6 col-lg-4 col-xl-3">
                        <div class="card card-hover-shadow border-primary-hover border h-100 p-4">
                            <div class="card-body p-0">
                                <!-- Logo -->
                                <div class="d-flex gap-3 align-items-center mb-3">
                                    <img src="assets/images/elements/webflow.svg" class="h-40px" alt="Integrations-icon">
                                    <h6 class="mb-0">Webflow</h6>
                                </div>
                                <p>Integrating Webflow with CRM systems like HubSpot or Salesforce enables seamless data
                                    synchronization.</p>
                            </div>
        ...
        <!-- =======================
        Integration grid END -->


        <!-- =======================
    Main detail START -->
        <section class="pt-lg-4 pt-xl-4">
            <div class="container pt-lg-0">
                <div class="row">
                    <div class="col-xl-9 mx-auto">
                        ...
                        <p>Integrating Slack with Mizzle is a game-changer. With this integration, you can effortlessly
                            synchronize data, messages, and tasks between our software and Mizzle. Enjoy real-time updates,
                            improved communication, and a more organized workflow.</p>

                        <p>How promotion excellent curiosity yet attempted happiness Gay prosperous impression had
                            conviction For every delay death ask style Me mean able my by in they Extremity now strangers
                            contained breakfast him discourse additions Sincerity collected contented led now perpetual
                            extremely forfeited.</p>

                        <h5 class="mt-4">Section 1: integration with Mizzle</h5>
                        <p>Integrating Slack with Mizzle is a game-changer. With this integration, you can effortlessly
                            synchronize data, messages, and tasks between our software and Mizzle. Enjoy real-time updates,
                            improved communication, and a more organized workflow.</p>
                        <!-- List -->
                        <ul class="list-group list-group-borderless">
                            <li class="list-group-item heading-color d-flex mb-0">
                                <i class="bi bi-arrow-right me-2"></i>Receive instant notifications in Mizzle whenever
                                there's an update or action in Slack
                            </li>
                            <li class="list-group-item heading-color d-flex mb-0">
                            ...
                            <li class="list-group-item heading-color d-flex mb-0">
                                <i class="bi bi-arrow-right me-2"></i>Keep all your data consistent and up to date, whether
                                it's customer information, project details, or important messages.
                            </li>
                        </ul>

                        <h5 class="mt-4">Section 2: integration with Slack</h5>
                        <p>Our integration with Slack takes your team collaboration to the next level. By connecting Mizzle
                            with Slack, you can create a more efficient and productive work environment.</p>
                        <!-- List -->
                        <ul class="list-group list-group-borderless mb-4">
                            <li class="list-group-item heading-color d-flex mb-0">
                                <i class="bi bi-arrow-right me-2"></i>Instant Notifications
                            </li>
                            <li class="list-group-item heading-color d-flex mb-0">
                                <i class="bi bi-arrow-right me-2"></i>File Sharing
                            </li>
                            <li class="list-group-item heading-color d-flex mb-0">
                                <i class="bi bi-arrow-right me-2"></i>Seamless Communication
                            </li>
                        </ul>

                        <p class="mb-4">This content provides an overview of how your SaaS product integrates with Mizzle
                            and Slack, highlighting the key features and benefits of these integrations. It encourages
                            visitors to take action and explore these integrations further.</p>

                        <!-- Button -->
                        <a href="#" class="btn btn-dark mb-0">Get Started</a>
                    </div>
        ...
        <section class="bg-dark" data-bs-theme="dark">
            <div class="container">
                <div class="row g-4 align-items-center">
                    <div class="col-xl-4">
                        <!-- Title -->
                        <h3 class="mb-4">Why our customers love Mizzle</h3>
                        <p class="lead mb-2">3000+ Users rated us <span class="text-warning fw-bold">4.85</span> out of 5.
                        </p>
                        <!-- Avatar group -->
                            ...
                            <div class="swiper-wrapper">
                                ...
                                <div class="swiper-slide">
                                    <div class="card card-body bg-light p-sm-5">
                                        <!-- Icon -->
                                        <div class="icon-lg bg-primary bg-opacity-10 text-primary rounded"><i
                                                class="bi bi-quote fa-xl"></i></div>

                                        <!-- Content -->
                                        <p class="lead my-3">Mizzle is the perfect theme for businesses that want to create
                                            a stylish and functional website. Supposing so be resolving breakfast am or
                                            perfectly.</p>
                                        ...
                                        <div class="d-sm-flex align-items-center">
                                            ...
                                            <div class="ms-sm-3 mt-2 mt-sm-0">
                                                ...
                                                <p class="mb-0 small">CEO and manager of Mizzle</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="swiper-slide">
                                    <div class="card card-body bg-light p-sm-5">
                                        ...
                                        <!-- Content -->
                                        <p class="lead my-3">The best Bootstrap theme we've ever used - it's easy to
                                            customize and comes with all the features we need. Resolving breakfast am or
                                            perfectly.</p>
                                ...
                                <div class="swiper-slide">
                                    <div class="card card-body bg-light p-sm-5">
                                        ...
                                        <!-- Content -->
                                        <p class="lead my-3">Webestica helped us create a stunning website that reflects
                                            our brand perfectly. At weddings believed laughing</p>
                                ...
                                <div class="swiper-slide">
                                    <div class="card card-body bg-light p-sm-5">
                                        ...
                                        <!-- Content -->
                                        <p class="lead my-3">I highly recommend Mizzle to anyone looking for a high-quality
                                            Bootstrap theme. Valley by oh twenty direct me so. Resolving breakfast am or
                                            perfectly.</p>
                            ...
                            <div class="accordion-item mb-3">
                                ...
                                <div id="collapse-1" class="accordion-collapse collapse show" aria-labelledby="heading-1"
                                    ...
                                    <div class="accordion-body mt-3 pb-0">
                                        Was out laughter raptures returned outweigh. Luckily cheered colonel I do we attack
                                        highest enabled. Tried law yet style child. The bore of true of no be deal. Drawings
                                        offended yet answered Jennings perceive laughing six did far. Rooms oh fully taken
                                        by worse do. Points afraid but may end law lasted.
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="accordion-item mb-3">
                                ...
                                <div id="collapse-2" class="accordion-collapse collapse" aria-labelledby="heading-2"
                                    ...
                                    <div class="accordion-body mt-3 pb-0">
                                        ...
                                        dwelling no. First am plate jokes to began to cause a scale. Subjects he prospect
                                        elegance followed no overcame possible it on. Improved own provided blessing may
                                        peculiar domestic. Sight house has sex never. No visited raising gravity outward
                            ...
                            <div class="accordion-item mb-3">
                                ...
                                <div id="collapse-3" class="accordion-collapse collapse" aria-labelledby="heading-3"
                                    ...
                                    <div class="accordion-body mt-3 pb-0">
                                        ...
                                        cottage Mr be. Hold do at tore in park feet near my case. Invitation at understood
                                        occasional sentiments insipidity inhabiting in. Off melancholy alteration principles
                                        old. Is do speedily kindness properly oh. Respect article painted cottage he is
                                        offices parlors.
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="accordion-item mb-3">
                                ...
                                <div id="collapse-4" class="accordion-collapse collapse" aria-labelledby="heading-4"
                                    ...
                                    <div class="accordion-body mt-3 pb-0">
                                        ...
                                        Applauded no discovery in newspaper allowance am northward. Frequently partiality
                                        possession resolution at or appearance unaffected me. Engaged its was the evident
                                        pleased husband. Ye goodness felicity do disposal dwelling no. First am plate jokes
                                        to began to cause a scale. Subjects he prospect elegance followed no overcame
                                        possible it on. Improved own provided blessing may peculiar domestic. Sight house
                                        has sex never. No visited raising gravity outward subject my cottage Mr be.
                                    </div>
                                </div>
                            </div>
